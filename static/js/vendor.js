...
var modalObject = (function(){
	...
	return {
		...
		bindModalButtonsTarget: function(callback, id) {
			var $modalButtons = id;
			updateModalButtonADA($modalButtons);
			$modalButtons.on('click', callback(id));
		}
	};
}());
...
/*! jQuery Validation Plugin - v1.19.5 - 3/16/2023
